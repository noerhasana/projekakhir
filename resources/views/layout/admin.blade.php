...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('template/dist/img/meidy.png') }}" alt="AdminLTELogo"
                height="60" width="60">
        </div>
      ...
      <span class="brand-text font-weight-light">AdminLTE 3</span>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('template/dist/img/meidy.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
