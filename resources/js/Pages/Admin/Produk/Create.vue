...
function store() {
    ...
    if (formData.value.kategori_produk_id && typeof formData.value.kategori_produk_id == 'object') {
    ...
    router.post(route('produk.store'), formData.value, {
        onError: () => {
...
<template>
    ...
    <AuthenticatedLayout>
        <template #name>Tambah Produk</template>
        <template #default>
            <div class="mb-8">
                    ...
                    <div id="varian" class="max-h-[75vh] overflow-auto pr-4">
                        ...
                        <div :id="'listProduk.'+i" v-for="(produk, i) in formData.listProduk" class="pb-8 pt-4 first:pt-0 border-b last:border-0">
                            ...
                            <div class="mb-5">
                                ...
                                <p v-if="errors[`listProduk.${i}.pathImages`]" class="text-red-500">{{ errors[`listProduk.${i}.pathImages`] }}</p>
                            </div>
                        </div>
                    </div>
                    <form @submit.prevent="">
                        ...
                        <div class="mb-5 flex justify-end">
                            <Button @click="store" label="Simpan" type="submit" icon="fa fa-check" iconPos="right"  />
                        </div>
                    </form>
                </div>
            </div>
